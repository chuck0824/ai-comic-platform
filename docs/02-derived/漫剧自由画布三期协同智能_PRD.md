...
一期解决创作闭环，二期补齐专业编辑和控制能力，三期重点面向团队协作、规模化生产、项目管理、资产沉淀和智能自动化。

三期需要让编剧、分镜师、美术、视频后期、运营、审核、项目负责人可以围绕同一个画布协作，并让系统能够基于已有资产和工作流自动推荐、自动补全、自动执行部分生产任务。
...
| 审核类型 | 单选框 | 脚本审核、分镜图审核、视频片段审核、成片审核、资产审核 | 单一选项 |
| 审核说明 | 多行文本框 | 用户输入 | 可选 |
