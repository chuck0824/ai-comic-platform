...
> 本节内容基于 `docs/superpowers/specs/2026-07-05-canvas-production-kernel-completion-design.md` 及 R0-R4 实施计划。V1.8 将 Canvas 从"画布页面接口"升级为完整的生产内核，引入双模式、ShotWorkUnit、类型化端口、导演台版本流、模型适配器管线、质量报告和交付清单。
...
详见各阶段实施计划：`docs/superpowers/plans/2026-07-05-canvas-production-kernel-r0-stabilization.md` ~ `r4-quality-delivery.md`。
