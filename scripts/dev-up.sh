...
# R2-A 阶段事实链（默认关；本地灰度：AICP_SCRIPT_STAGE_TRUTH_ENABLED=true VITE_SCRIPT_STAGE_TRUTH_ENABLED=true）
export AICP_SCRIPT_STAGE_TRUTH_ENABLED="${AICP_SCRIPT_STAGE_TRUTH_ENABLED:-false}"
export VITE_SCRIPT_STAGE_TRUTH_ENABLED="${VITE_SCRIPT_STAGE_TRUTH_ENABLED:-false}"
export JWT_SECRET="${JWT_SECRET:-${AICP_JWT_SECRET}}"
