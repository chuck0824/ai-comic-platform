...
public class WorldbuildingController {
    ...
    public ApiResponse<List<CharacterProfile>> listCharacters(@PathVariable Long projectId) {
        projectAccessService.require(projectId, SecurityUtil.requireCurrentUserId(), Action.VIEW);
        return ApiResponse.success(wb.listCharacters(projectId));
    }
    ...
    @GetMapping("/tasks")
    public ApiResponse<List<PlotTask>> listTasks(@PathVariable Long projectId) {
        projectAccessService.require(projectId, SecurityUtil.requireCurrentUserId(), Action.VIEW);
        return ApiResponse.success(wb.listTasks(projectId));
    }
    ...
    @GetMapping("/volumes")
    public ApiResponse<List<VolumeOutline>> listVolumes(@PathVariable Long projectId) {
        projectAccessService.require(projectId, SecurityUtil.requireCurrentUserId(), Action.VIEW);
        return ApiResponse.success(wb.listVolumes(projectId));
    }
    ...
    public ApiResponse<List<WorldLocation>> listLocations(@PathVariable Long projectId) {
        projectAccessService.require(projectId, SecurityUtil.requireCurrentUserId(), Action.VIEW);
        return ApiResponse.success(wb.listLocations(projectId));
    }
    ...
    // Summary
    @GetMapping("/summary")
    public ApiResponse<Map<String,Object>> worldSummary(@PathVariable Long projectId) {
        projectAccessService.require(projectId, SecurityUtil.requireCurrentUserId(), Action.VIEW);
        return ApiResponse.success(wb.getWorldSummary(projectId));
    }
}
